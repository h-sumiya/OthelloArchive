...
<div class="body">
    ...
    <div class="inner">
        ...
        {#if select === 0}
            <p>
                今回のプロジェクトは主にRustというプログラミング言語で開発しました。
            </p>
            <p>
                Rustは数あるプログラミング言語の中でも最も高いパフォーマンスを発揮するこのできる言語の一つであり、今回のようにブラウザ上で実行、
                することができるなど、ほぼすべてのプラットフォームに向けてコンパイルすることもできます。
            </p>
            <p>
        ...
        {:else if select === 2}
            ...
            <p>
                今回のプロジェクトは期間が少なかったためSvelteのお陰でサイトを完成させることができました。
            </p>
            <p>
                入門に最適なチュートリアルはこちら<a
    ...
    <div class="inner">
        ...
        <p>
            今回作成したAIでは1ターン目から60ターン目の点差をPyTorchを用いて学習させたニューラルネットワークによって評価値を算出しています。
        </p>
        <p>
